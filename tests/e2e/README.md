...
| `does not inject card and art tags into the public deck preview panel` | Public deck preview panels do not get persistent tag controls when no dropdown/context menu is open. |
